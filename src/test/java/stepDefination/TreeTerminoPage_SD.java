...
public class TreeTerminoPage_SD {
	...
	TreePage_TryEditor tryeditorlink = new TreePage_TryEditor();
		...
		@Given("User on trees page after loggedin")
	public void user_on_trees_page_after_loggedin() {
...
//			HomePagePOM.dropDown();
	...
	public void user_clicks_on_terminologies_link() {
		...
		TreePage.terminologiesclick();
		
		
	   // throw new io.cucumber.java.PendingException();
	}

	@Then("Terminologies page should open")
	public void terminologies_page_should_open() {
		
	
		System.out.println("on Terminologies Page poonam");
